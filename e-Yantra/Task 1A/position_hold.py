...
class swift():
	...
	def __init__(self):
		...
		self.roll_prev_error = 0.0                                                                            # for x_axis
		self.pitch_prev_error = 0.0                                                                           # for y_axis
		self.throttle_prev_error = 0.0                                                                        # for z_axis 
		
		self.roll_error = 0.0                                                                                 # for x_axis
		self.pitch_error = 0.0                                                                                # for y_axis
		self.throttle_error = 0.0                                                                             # for z_axis 
		
		self.roll_sum_error = 0.0                                                                             # for x_axis
		self.pitch_sum_error = 0.0                                                                            # for y_axis
		self.throttle_sum_error = 0.0                                                                         # for z_axis 
	...
	#	8. Add error_sum
		...
		self.throttle_error= self.drone_position[2] - self.setpoint[2]
...
if __name__ == '__main__':
	...
	swift_drone = swift()
	r = rospy.Rate(33) #cify rate in Hz based upon your desired PID sampling time, i.e. if desired sample time is 33ms specify rate as 30Hz
